...
test("renderSimplePdf transliterates Turkish letters outside WinAnsiEncoding but keeps native Latin-1 Turkish letters untouched", () => {
  ...
  assert.ok(text.includes(String.fromCharCode(66,97,115,108,105,107,32,105,71,115,220,246,231)), "transliteration must only replace ş/ğ/ı/İ, leaving native Latin-1 Turkish letters (Ü, ö, ç) untouched");
});
