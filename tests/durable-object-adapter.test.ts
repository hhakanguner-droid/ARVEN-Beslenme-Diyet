...
const MIGRATIONS = ["0001_initial.sql", "0002_phase2_identity.sql", "0003_phase3_planning.sql", "0004_phase4_ai.sql", "0005_phase5_vision.sql", "0006_phase6_health.sql", "0007_phase6_health_hardening.sql", "0008_phase7_planning.sql", "0009_phase8_progress.sql", "0010_phase9_deletion_hardening.sql", "0011_ai_provider_settings.sql"].map(
