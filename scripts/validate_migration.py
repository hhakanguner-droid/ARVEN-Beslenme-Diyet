...
def main() -> None:
    ...
    expect_rejected(conn, "changing payload after confirmation", """
      UPDATE ai_actions SET payload_json='{"localDate":"2026-09-02","occurredAt":"2026-09-02T00:00:00Z","mealType":"lunch","items":[{"foodId":"food-a","grams":99,"calculationVersion":"v1"}]}',
        status='applied', applied_at=? WHERE id='ai-good'
    """, (NOW,))
