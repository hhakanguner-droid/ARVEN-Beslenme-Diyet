...
7. **Health boundary:** the product is not diagnostic or treatment software. Do not diagnose, prescribe, instruct medication changes or turn OCR/photo estimates into facts. Medication-safety checks must receive the authenticated user's active medication names when available so direct drug-name directives fail closed.
